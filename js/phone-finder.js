...
const showPhoneDetais = (info) => {
  ...
  detailsContainer.innerHTML = `
    ...
    <div class="card-body">
      ...
      <p class="card-text">Sensors: ${info.mainFeatures.sensors[0]}, ${
    info.mainFeatures.sensors[1]
  }, ${info.mainFeatures.sensors[2]}, ${info.mainFeatures.sensors[3]}, ${
    info.mainFeatures.sensors[4]
  ...
  <p class="card-text"> ${
    info.others?.Bluetooth ? info?.others?.Bluetooth : "No Others Found"
  }</p>
